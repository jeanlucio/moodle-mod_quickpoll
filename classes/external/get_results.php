...
/**
 * External function for reading quickpoll results.
 *
...
/**
 * Returns aggregated quickpoll results.
 */
class get_results extends external_api {
    ...
    /**
     * Returns result counts and respondents.
     *
    ...
    public static function execute(int $cmid): array {
        ...
        return poll_exporter::export_results($poll, (int) $cm->id, $context);
    }
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            'canviewresults' => new external_value(PARAM_BOOL, 'Whether results are visible'),
            'questions' => new external_multiple_structure(self::question_structure()),
        ]);
    }

    /**
     * Defines a result question structure.
     *
     * @return external_single_structure
     */
    private static function question_structure(): external_single_structure {
        return new external_single_structure([
            ...
            'total' => new external_value(PARAM_INT, 'Total votes for this question'),
            'options' => new external_multiple_structure(self::option_structure()),
        ]);
    }

    /**
     * Defines a result option structure.
     *
     * @return external_single_structure
     */
    private static function option_structure(): external_single_structure {
        return new external_single_structure([
            ...
            'percent' => new external_value(PARAM_FLOAT, 'Vote percentage'),
